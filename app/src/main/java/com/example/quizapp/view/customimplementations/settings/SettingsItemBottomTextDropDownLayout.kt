...
import com.example.quizapp.databinding.SettingsItemBottomTextDropdownBinding
...
class SettingsItemBottomTextDropDownLayout constructor(
    ...
    val binding: SettingsItemBottomTextDropdownBinding = SettingsItemBottomTextDropdownBinding.inflate(LayoutInflater.from(context), this, true)
