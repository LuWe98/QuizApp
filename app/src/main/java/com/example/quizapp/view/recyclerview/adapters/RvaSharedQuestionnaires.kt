...
class RvaSharedQuestionnaires : BindingListAdapter<CompleteQuestionnaire, RviQuestionnaireCachedBinding>(CompleteQuestionnaire.DIFF_CALLBACK) {
    ...
    override fun bindViews(binding: RviQuestionnaireCachedBinding, item: CompleteQuestionnaire, position: Int) {
        binding.apply {
            ...
            tvInfo.text = context.getString(R.string.cosAndSubject, item.courseOfStudiesAbbreviations, item.questionnaire.subject)
