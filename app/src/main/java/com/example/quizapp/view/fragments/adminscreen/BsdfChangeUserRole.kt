...
import com.example.quizapp.databinding.BsdfChangeUserRoleBinding
...
@AndroidEntryPoint
class BsdfChangeUserRole : BindingBottomSheetDialogFragment<BsdfChangeUserRoleBinding>() {
    ...
    private val args: BsdfChangeUserRoleArgs by navArgs()
    ...
    private fun initObservers(){
        vmRole.fragmentChangeUserRoleEventChannelFlow.observe(viewLifecycleOwner) { event ->
            when(event) {
