...
abstract class QuestionnaireDao : BaseDao<Questionnaire> {
    ...
    abstract suspend fun findCompleteQuestionnaireWith(questionnaireIds: List<String>) : QuestionnaireWithQuestionsAndAnswers
    ...
    abstract suspend fun findAllSyncedQuestionnaires(syncStatus: SyncStatus = SyncStatus.SYNCED): List<QuestionnaireWithQuestionsAndAnswers>
